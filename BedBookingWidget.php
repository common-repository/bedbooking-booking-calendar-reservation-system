...
class BedBookingWidget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		$calendarId = "";
        if(isset($data['calendarId'])) { $calendarId = ",".(int)$data['calendarId']; }

        ?>
        <?php if($type == -1) :    ?>

            <div id='bedbooking-widget-search'><center><img style='width:50px !important; height:50px !important;' src='https://panel.bed-booking.com/widget/gfx/loader.gif' alt='' /><br/><a href='http://bed-booking.com' style='color:#73b819 !important' rel='nofollow'>BedBooking</a></center></div>
        ...
        <?php elseif($type == 0):  ?>
            <div id='bedbooking-calendar-0'><center><img style='width:50px !important; height:50px !important;' src='https://panel.bed-booking.com/widget/gfx/loader.gif' alt='' /><br/><a href='http://bed-booking.com' style='color:#73b819 !important' rel='nofollow'>BedBooking</a></center></div><script type='text/javascript'>jQuery(document).ready(function() { new CalendarFull('<?php echo $data['calendarcode'];?>', '0', 'bedbooking-calendar-0', { normal: '7dbb2c',  reserved: 'fb1643', nextMonth: 'ecf5e1', font:'81817f', width: 450, lang: <?php echo $lang;?>,  statistic : 'bb_wp_full'  } <?php echo $calendarId; ?>); }); </script>
        <?php else :  ?>
            <div id='bedbooking-calendar-<?php echo $type ;?>'><center><img style='width:50px !important; height:50px !important;' src='https://panel.bed-booking.com/widget/gfx/loader.gif' alt='' /><br/><a href='http://bed-booking.com' style='color:#73b819 !important' rel='nofollow'>BedBooking</a></center></div><script type='text/javascript'>jQuery(document).ready(function() { new Calendar('<?php echo $data['calendarcode'];?>', '<?php echo $type ;?>', 'bedbooking-calendar-<?php echo $type ;?>', { normal: '7dbb2c',  reserved: 'fb1643', nextMonth: 'ecf5e1', font:'81817f', width: 450, lang: <?php echo $lang;?>, statistic : 'bb_wp_room' } <?php echo $calendarId; ?>); }); </script>
        <?php endif;?>
